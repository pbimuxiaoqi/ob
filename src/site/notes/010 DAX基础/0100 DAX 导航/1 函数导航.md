...
| [[010 DAX基础/0120 DAX 函数/DISTINCTCOUNT\|DISTINCTCOUNT]]                       | \-                          | \-     | \-     | \-   |
| [[010 DAX基础/0120 DAX 函数/DISTINCTCOUNTNOBLANK\|DISTINCTCOUNTNOBLANK]]         | \-                          | \-     | 5      | 1    |
...
| [[010 DAX基础/0120 DAX 函数/DATEADD\|DATEADD]]                             | 按指定的时间间隔移动给定的日期集       | 表      | \-     | \-   |
| [[010 DAX基础/0120 DAX 函数/未命名\|未命名]]                                     | 计算与当前年份年底相对应的日期的指定表达式。 | \-     | 1      | 1    |
| [[999 模板/函数模板\|函数模板]]                                                  | \-                     | \-     | \-     | \-   |
